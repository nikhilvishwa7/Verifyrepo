class script(object):
    START_TXT = """<b>ʜᴇʟʟᴏ {},
𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 <a href=https://t.me/{}>{}</a>, Join My Update Channel Here You Got All Your Movie, Nichha Diya hua update Channel Join karlo Uspe Tumhe Movie milega ega    
    HELP_TXT = """<b>𝙷𝙴𝚈 {}
...
✯ ʙᴜɪʟᴅ sᴛᴀᴛᴜs: v2.0.1 [ ʙᴇᴛᴀ ]</b>"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
<b>- ɢᴀᴀɴᴅ ᴍᴀʀᴀᴏ ʙsᴅᴋ. 
- 𝚂𝙾𝚄𝚁𝙲𝙴 -<a href=https://t.me/Vis10n7>Paisa Lagega</a>"""
...
╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗
▫️<a href=https://t.me/Update_Channel7> ᴄʜᴀɴɴᴇʟ </a>
...
ᴘʟᴇᴀꜱᴇ ᴠᴇʀɪғʏ ɴᴏᴡ ᴀɴᴅ ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ Till ɴᴇxᴛ Day...

If You Verify You Got all Files Directly </b>"""
